...
TEST(andrew_convex_hull, simple)
{
   using cg::point_2;
...
TEST(andrew_convex_hull, simple2)
{
   using cg::point_2;
...
TEST(andrew_convex_hull, one_point)
{
    using cg::point_2;
...
TEST(andrew_convex_hull, same_points)
{
    using cg::point_2;
...
TEST(andrew_convex_hull, uniform)
{
   using cg::point_2;
